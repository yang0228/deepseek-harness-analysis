...
本章描述提交 `0d1f50007f9bca3f52b06e1c3074fa14d5fb0720` 的文件系统效果约束。未运行跨平台探针，不从操作系统名称推导部署的实际 enforcement。
...
模式词汇只描述文件效果，不承诺统一的网络限制或进程可见性规则。个别 backend 可以有更强机制，但不能泛化为所有平台共同保证。[模式与 enforcement](https://github.com/deepseek-ai/deepseek-harness/blob/0d1f50007f9bca3f52b06e1c3074fa14d5fb0720/docs/subsystems/sandbox.md#L9-L35)
...
| Windows | ACL restricted-token runner | workspace SID 与 Session 私有 temp SID 分离；Everyone 和 hard-link 缺口使其为 `partial` |

Provider 缓存选择结果到生命周期结束；修复运行器后需重载。单候选可跳过探针，但运行器自身拒绝仍必须作为失败报告。自定义 `runnerCommand` 跳过探针并相信操作者声明，因此不能把其 `full` 字段误读为独立安全审计。[选择、平台机制](https://github.com/deepseek-ai/deepseek-harness/blob/0d1f50007f9bca3f52b06e1c3074fa14d5fb0720/packages/sandbox/sandbox-local/README.md#L69-L87)；[已知限制](https://github.com/deepseek-ai/deepseek-harness/blob/0d1f50007f9bca3f52b06e1c3074fa14d5fb0720/packages/sandbox/sandbox-local/README.md#L128-L134)
...
`await ctx.sandbox.confine(argv, policy, signal)` 在执行环境中解析路径并返回包装后的 argv；取消可以阻止尚未开始的启动。Consumer 负责执行和结果归因。`denial` 表示活动约束下的文件操作被拒；`runner failure` 表示运行器在内层命令执行前失败，必须优先识别。[分类规则](https://github.com/deepseek-ai/deepseek-harness/blob/0d1f50007f9bca3f52b06e1c3074fa14d5fb0720/docs/subsystems/sandbox.md#L98-L156)

### 与 PTC 和远程执行的关系

当前 Node PTC Provider 也使用 Sandbox 和 subprocess 服务：受约束模式不可用时不允许悄悄以原始 Node 执行。文件策略、输出限制和进程清理仍是三个独立承诺，不能合并为“绝对安全”。[PTC 文件策略](https://github.com/deepseek-ai/deepseek-harness/blob/0d1f50007f9bca3f52b06e1c3074fa14d5fb0720/packages/ptc-runtime/ptc-runtime-node/README.md#L12)；[PTC 限制](https://github.com/deepseek-ai/deepseek-harness/blob/0d1f50007f9bca3f52b06e1c3074fa14d5fb0720/packages/ptc-runtime/ptc-runtime-node/README.md#L137-L144)

`dsh-sandbox-ssh` 则与 SSH filesystem/subprocess 提供方配套在远端施加策略；这不是把本地 wrapper 路径传给远端。[SSH Sandbox](https://github.com/deepseek-ai/deepseek-harness/blob/0d1f50007f9bca3f52b06e1c3074fa14d5fb0720/docs/subsystems/sandbox.md#L5)

## 源码导读

| Claim / 主题 | 固定来源 |
|---|---|
| `DSH-DD-SANDBOX-001` | [模式词汇](https://github.com/deepseek-ai/deepseek-harness/blob/0d1f50007f9bca3f52b06e1c3074fa14d5fb0720/docs/subsystems/sandbox.md#L9-L35)；[每调用解析](https://github.com/deepseek-ai/deepseek-harness/blob/0d1f50007f9bca3f52b06e1c3074fa14d5fb0720/packages/sandbox/sandbox-policy/src/index.ts#L155-L179) |
| `DSH-DD-SANDBOX-002` | [本地选择与状态](https://github.com/deepseek-ai/deepseek-harness/blob/0d1f50007f9bca3f52b06e1c3074fa14d5fb0720/packages/sandbox/sandbox-local/README.md#L51-L81)；[平台限制](https://github.com/deepseek-ai/deepseek-harness/blob/0d1f50007f9bca3f52b06e1c3074fa14d5fb0720/packages/sandbox/sandbox-local/README.md#L128-L134) |
| `DSH-DD-SANDBOX-003` | [失败关闭](https://github.com/deepseek-ai/deepseek-harness/blob/0d1f50007f9bca3f52b06e1c3074fa14d5fb0720/docs/subsystems/sandbox.md#L154-L158)；[运行器错误](https://github.com/deepseek-ai/deepseek-harness/blob/0d1f50007f9bca3f52b06e1c3074fa14d5fb0720/packages/sandbox/sandbox-local/README.md#L55-L57) |
